...
<a href='https://github.com/daniel620/voice-assistant-web-app'><i class='fab fa-github'></i> Github</a>
...
<figure>
  <a href=''><img src='/images/web-voice-assistant/web-voice-assistant.png' style='max-width: 80%; height: auto;'></a>
  <figcaption>
  Powered by GPT-3-turbo and TTS & STT from IBM Watson
</figcaption>
</figure>
"
...
For more details, please refer to the [Github repository](https://github.com/daniel620/voice-assistant-web-app).
